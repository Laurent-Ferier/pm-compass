...
Open it from the ribbon icon in the left sidebar, or from the command palette with **PM Compass: Open dashboard**. It opens as a tab; asking again brings the tab you already have forward rather than making a second one.
