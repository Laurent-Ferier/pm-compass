...
const CAPTIONS = {
  ...
  notes: "The IO layer. A note reads and writes one file and holds none of what it says.",
  stores: "Where the readings are held, one entry per path, and who watches the vault for them.",
